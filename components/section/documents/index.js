            ...
            >
                ...
                <div className={'w-full h-full'} onMouseOver={() => setStandby(true)}>
                    <Card
                        standby={standby}
                        link={'eflyer.pdf'}
                        svg={<svg className={'mx-auto w-28 h-28 p-4'} fill={'rgb(31, 41, 55)'} viewBox="0 0 24 24"><path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"></path></svg>}
                        title={'E-flyer'}
                    />
                </div>
            </div>
